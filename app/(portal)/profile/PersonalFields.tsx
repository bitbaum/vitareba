  ...
  return (
    <div className={styles.card}>
      ...
      <div className={profileStyles.fieldGrid}>
        ...
        <div className={authStyles.field}>
          <label className={authStyles.label} htmlFor="dob">
            Date of birth
          </label>
          <input
            id="dob"
        ...
        <div className={authStyles.field}>
          ...
          <label className={authStyles.label} htmlFor="sex">
            Sex — used for lab reference ranges
          </label>
          <select
            id="sex"
            className={authStyles.input}
        ...
        <div className={authStyles.field}>
          <label className={authStyles.label} htmlFor="phone">
            Phone
          </label>
          <input
            id="phone"
        ...
        <div className={authStyles.field}>
          <label className={authStyles.label} htmlFor="city">
            City
          </label>
          <input
            id="city"
        ...
        <div className={authStyles.field}>
          <label className={authStyles.label} htmlFor="occupation">
            Occupation
          </label>
          <input
            id="occupation"
            ...
            placeholder="Founder, engineer, executive…"
          />
        </div>
      </div>
    </div>
